...
> logic: the larger number suggest the higher priority
    ...
    if dog inclined: 
        incline = 14, mode0=left_incline, mode1=right_incline
    if not:
        if dog out the range: stand at the boundary
            back = 11 : move forth
            forth = 12 : move back
            boundary_lr = 13 : move right or left, mode0=left boundary, mode1=...
